...
BeeswaxClient.prototype.uploadSegmentFile = function (params) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        fileStream.push(params.file);
       

        axios.post(urlUtils.resolve(self.apiRoot, '/rest/segment_upload/upload/' + params.segment_id), form).then(function (response) {
            resolve({ success: true, payload: response.data });
        }).catch(function (error) {
            reject(error);
        });
    });
