...
BeeswaxClient.prototype.uploadSegmentFile = function (params) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        form.append('segment_file', params.file, {
            filename: params.file.originalname, // Adjust this if necessary
            contentType: params.file.mimetype // Adjust this if necessary
        });
        ...
        self.request('post', {
            ...
            resolve({ success: true, payload: body });
        }).catch(function (error) {
            reject(error);
        });
    });
